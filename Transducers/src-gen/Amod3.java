...
public final class Amod3 {
  ...
  public static ITransducer createCoder() {
    ...
    $try:try {
      ...
      $line=43;
      Object Out=$fix(GCollections.asSet('0','1','2'));
      $line=44;
      Object q_0=$fix(0);
      $line=45;
      Object F=$fix(Q);
  ...
  public static ITransducer createDecoder() {
    ...
    $try:try {
      ...
      $line=65;
      Object F=$fix(GCollections.asSet(0,2,1,"I"));
      $line=66;
  ...
  public static Object \u03B41(Object q, Object s) {
    ...
    $try:try {
      ...
      $line=75;
      if (($opMembrY(q,$opIntvlY(0,2))&&$bool(($opEqualY(q,d)||$opEqualY($opModulY($opAdditY(q,1),3),d))))) {
        $line=75;
        $result=d;
        if (true) break $try;
      }
